angular.module('dogs').controller('DogsController', ['$scope', '$routeParams', '$location', 'Global', 'Dogs', function ($scope, $routeParams, $location, Global, Dogs) {
    $scope.global = Global;

    $scope.toggleBlacklist = function(dogId) {
